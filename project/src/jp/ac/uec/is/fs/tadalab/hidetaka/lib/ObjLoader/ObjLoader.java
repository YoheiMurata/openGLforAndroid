package jp.ac.uec.is.fs.tadalab.hidetaka.lib.ObjLoader;

import java.io.DataInputStream;
import java.util.ArrayList;
import java.util.HashMap;

import jp.ac.uec.is.fs.tadalab.hidetaka.lib.opengl.Figure;
import jp.ac.uec.is.fs.tadalab.hidetaka.lib.opengl.GLES;
import jp.ac.uec.is.fs.tadalab.hidetaka.lib.opengl.IndexBuffer;
import jp.ac.uec.is.fs.tadalab.hidetaka.lib.opengl.Material;
import jp.ac.uec.is.fs.tadalab.hidetaka.lib.opengl.Mesh;
import jp.ac.uec.is.fs.tadalab.hidetaka.lib.opengl.Texture;
import jp.ac.uec.is.fs.tadalab.hidetaka.lib.opengl.VertexBuffer;

/*
 * ObjLoader
 * 概要：
 * 　blenderなど作成したObjファイルを
 * OpenGLで使用できるフォーマットにパースするための
 * クラス
 */
